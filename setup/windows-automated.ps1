# windows-automated.ps1
############################
# Legacy automated setup script for Windows
############################
...
Write-Host "Starting automated Windows setup..." -ForegroundColor Green

# Define the path to the scripts
$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
$generalScript = Join-Path $scriptDir "windows-automated\general.ps1"
...
if ($Dev) {
    $devScript = Join-Path $scriptDir "windows-automated\dev.ps1"
...
if ($Gaming) {
    $gamingScript = Join-Path $scriptDir "windows-automated\gaming.ps1"
...
if ($GameDev) {
    $gameDevScript = Join-Path $scriptDir "windows-automated\game-dev.ps1"
...
if ($Python) {
    $pythonScript = Join-Path $scriptDir "windows-automated\python.ps1"
...
if ($Js) {
    $jsScript = Join-Path $scriptDir "windows-automated\js.ps1"
...
Write-Host "Automated Windows setup completed!" -ForegroundColor Green
